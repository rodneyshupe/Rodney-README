...
Heard a rumour? Need clarification on something? Blocked? I’d love to hear as soon as possible. Shoot me a Slack message, hop on a quick Teams Chat, we don’t need to wait for our next scheduled 1:1.
...
I work a bit on the weekends/after hours. This is my choice. I do not expect you to work on the weekend / after hours. I might Slack you things, but unless the thing says URGENT, it can always wait until the next work day.

I take vacations. You should, too. You will do your best work when you are refreshed.
...
**People first.** I believe that happy, informed, and productive people build a fantastic product. I optimize for the people. Other leaders will maximize the business, the technology, or any different number of important facets. Ideological diversity is key to an effective team. All perspectives are relevant, and we need all these leaders, but my bias is towards building productive humans.

**Leadership comes from everywhere.** While managers are an essential part of a scaling organization, I don’t believe they have a monopoly on Leadership. I work hard to build other constructs and opportunities for any person on the team to be a leader.

**I see things as systems.** I reduce all complex things into systems. I think in flowcharts. I take great joy in attempting to understand how these systems and flowcharts all fit and work together. When I see large or small inefficiencies in these complex systems, I’d like to fix them with your help.

**It is important to me that people are treated fairly.** I believe that most people are trying to do the right thing, but unconscious bias leads them astray. I work hard to understand and address my biases because I understand their ability to create inequity. I believe those in power have a disproportionate responsibility to proactively invest in people who have historically been disadvantaged.
...
**Firefight.** One of my favourite opening lines is "I could use a hand with...", my second favourite is "I screwed up: ...". A mistake, if shared, becomes a challenge; if hidden, becomes a failure.
...
I will give you feedback on how you're doing continuously, including in our 1:1s. If I'm worried about your performance, I will let you know. My goal is for you to never be unsure about how you're performing (and how I think you're performing). If you ever feel unsure about either of these things, please let me know.

If you’d like specific feedback on something let me know! I’m happy to provide an outside perspective.

What should you do with feedback?  Consider it. Acting on it is not required. You’ll receive a lot of feedback. Most of it will be good, some of it won’t be. Like everything else, please think about each piece critically and decide whether to act on it or not.
...
If you can give me this feedback face-to-face (Teams or in person), that's my preference. If you're only comfortable kicking off a discussion with an email or a Slack message, I would rather you do that than not bring it up at all.
...
One way to do this is we can create a private Slack channel for us to track 1:1 topics, action items and decisions. You can use this to write down some things throughout the week that you want to chat about if you think that will help, since it can sometimes be hard to think of or bring up things in the moment.
...
* **Cooking and baking.** I love trying new recipes and new cooking techniques. I always want to hear about new recipes you've tried or want to try, or just chat about cooking and baking in general.  I have collected a bunch of recipes in a book ([Recipes from the Messy Chef](https://github.com/rodneyshupe/Cookbook)) that is built and hosted on github.  If you like cocktails I also have a book ([Libations](https://github.com/rodneyshupe/Libations)) on those too.
...
* **Sports** I am a huge Sports fan.  I am a season ticket holder for both the BC Lions and Whitecaps and travel to the Grey Cup most years and actually got to party with i the trophy for a night.  I usually do at least one BC Lions road trip each year.
<img src="/img/GreyCupNight.jpg" alt="Night out with the Grey Cup" width="300px">


## TODO

This document is still a wip. I’d love your feedback.
- Did you find the time you spent reading this valuable?
- Was something critical missing?
- Were there sections included that you didn’t find useful
